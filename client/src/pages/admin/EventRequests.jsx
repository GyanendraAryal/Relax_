...
export default function EventRequests() {
  ...
  return (
    <div>
      <h1 className="text-2xl font-bold text-stone-900">Event Requests</h1>
        ...
        <table className="w-full text-left text-sm">
          <thead className="bg-stone-50 text-stone-500 text-xs uppercase tracking-wider font-bold">
            <tr>
              ...
              <th className="p-3 border-b border-stone-200">Event</th>
              <th className="p-3 border-b border-stone-200">Date</th>
              <th className="p-3 border-b border-stone-200">Guests</th>
              <th className="p-3 border-b border-stone-200">Budget</th>
          ...
          <tbody className="divide-y divide-stone-100 bg-white">
            {items.length === 0 ? (
              <tr><td colSpan="8" className="p-8 text-center text-stone-500">No event requests found</td></tr>
            ) : items.map((r) => (
